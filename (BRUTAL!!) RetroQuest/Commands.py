...
def lookyourteeth_command(player, enemy=None):
    ...
    print(f"Health Points   : [ {player.acthp} / {player.total_max_hp} ] + {player.shield}")
    print(f"Mana Points : [ {player.actmana} / {player.max_mana} ]")
    print(f"Attributes:")
    print(f"STR : {player.total_strg}")
    print(f"DEX : {player.total_dex}")
    print(f"VIT : {player.total_vit}")
    print(f"INT : {player.total_intel}")
    print(f"CHA : {player.total_cha}")
    print(f"LUCK: {player.total_luck}")
